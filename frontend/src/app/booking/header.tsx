...
const Header = () => {
  ...
  return (
    <div className="w-full h-screen relative">
        <img className="w-full h-full object-cover" src="/assets/images/app/booking.jpg"/>
      ...
      <div className="absolute top-0 w-full h-full flex flex-col justify-center text-center text-white py-4">
        <h1 className="font-bold text-5xl py-2">Bookings</h1>
        <h3 className="py-7 text-3xl">Your order history</h3>
      </div>
    </div>
  );
};
